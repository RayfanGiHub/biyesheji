...
public class LocationBaiduMap extends Activity {
    ...
    public void logMsg(final String str, final int tag) {
        this.locationInfo = new String(str);
        MyLog.d("定位信息:", this.locationInfo);
...
//        }
    ...
    protected void onStop() {
        ...
        locationService.unregisterListener(rayfanListener);
    ...
    protected void onStart() {
        ...
        startLocation.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (startLocation.getText().toString().equals(getString(R.string.start))) {
                    locationService.start();// 定位SDK
                    // start之后会默认发起一次定位请求，开发者无须判断isstart并主动调用request
                    startLocation.setText(getString(R.string.stop));
                } else {
                    locationService.stop();
                    startLocation.setText(getString(R.string.start));
    ...
    private BDAbstractLocationListener rayfanListener = new BaiduMapUtil.LocationListener();
